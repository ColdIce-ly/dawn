package com.xiaoyuan.mqrocketmqtemplate;

import com.alibaba.fastjson.TypeReference;
import com.xiaoyuan.mqrocketmqtemplate.domain.OrderPaidEvent;
import com.xiaoyuan.mqrocketmqtemplate.domain.ProductWithPayload;
import com.xiaoyuan.mqrocketmqtemplate.domain.User;
...
@SpringBootTest
public class MqRocketmqTemplateApplicationTest {
    ...
    public void sendMessageTest(){
        ...
        sendResult = rocketMQTemplate.syncSend(springTopic, MessageBuilder.withPayload(
                new User().setUserAge((byte) 21).setUserName("Lester")).setHeader("content-Type", MimeTypeUtils.APPLICATION_JSON_VALUE).build());
        System.out.printf("syncSend1 to topic %s sendResult=%s %n", springTopic, sendResult);
